...
public class RollDicePlayer1 implements Dice{
	Scanner scanner = new Scanner(System.in);
	private ForestModel fModel;
	boolean startAgain=true;

    public RollDicePlayer1(ForestModel fModel) {
        this.fModel = fModel;
    }
	...
	public void throwDice(){
		while(startAgain){
			...
			if(choice.equalsIgnoreCase("T")){
				...
				if(dice==1 || dice==6){
					System.out.println(" "+fModel.getPlayer()[0].getName()+" YOU CAN START THE GAME");
					startAgain=false;
				}
				else{
