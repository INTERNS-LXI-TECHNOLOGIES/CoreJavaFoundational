...
public class RollDicePlayer2 implements Dice{
	Scanner scanner = new Scanner(System.in);
	private ForestModel fModel;
	boolean startAgain=true;

    public RollDicePlayer2(ForestModel fModel) {
        this.fModel = fModel;
    }
	...
	public void throwDice(){
		while(startAgain){
			...
			if(choice.equalsIgnoreCase("T")){
				...
				if(dice==1 || dice==6){
					System.out.println(" "+fModel.getPlayer()[1].getName()+" YOU CAN START THE GAME");
					startAgain=false;
				}
				else{
