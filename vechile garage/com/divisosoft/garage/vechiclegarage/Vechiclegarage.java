package com.divisosoft.garage.vechiclegarage;
...
public Vechicle[] vechicle =new Vechicle[10];
...
public void showcardetails(){
	...
	for(int i=0;i<5;i++){
		...
		if(vechicle[i] instanceof Car){
			System.out.println("\n"+((Car)vechicle[i]).getBrandname());
		    System.out.println(((Car)vechicle[i]).getRegno());
            System.out.println(((Car)vechicle[i]).getColor());
...
public void showmotorcycledetails(){
	System.out.println("\n"+"MOTORCYCLE DETAILS"+"\n");
		...
		for(int i=5;i<10;i++){
			System.out.println("\n"+((Motorcycle)vechicle[i]).getBrandname());
		    System.out.println(((Motorcycle)vechicle[i]).getRegno());
            System.out.println(((Motorcycle)vechicle[i]).getColor());
